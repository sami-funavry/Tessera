...
|-----------|---------|-----------------|---------|
| **Initial bond** (register) | 0.02 ETH | 80,000 uNTRN | Required to join the registry |
| **Operating** (50% of initial) | 0.01 ETH | 40,000 uNTRN | Below this: no new submissions accepted |
| **Deregistration** (25% of initial) | 0.005 ETH | 20,000 uNTRN | Below this: fully removed from registry |
